...
void __not_in_flash_func(base64_init_encodestate)(base64_encodestate* state_in)
{
...
size_t __not_in_flash_func(base64_encode_length)(size_t plain_len, base64_encodestate* state_in)
{
...
char __not_in_flash_func(base64_encode_value)(signed char value_in)
{
...
size_t __not_in_flash_func(base64_encode_block)(const void* plaintext_in, const size_t length_in, char* code_out, base64_encodestate* state_in)
{
